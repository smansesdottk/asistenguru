      ...
      <div className="flex flex-col flex-1">
        ...
        >
          {activeMessages.length === 0 && !isLoading && (
            <div className="flex flex-col justify-center items-center h-full max-w-4xl mx-auto py-12">
                <div className="text-center mb-8">
                  ...
                  <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white mb-2">Asisten Guru AI</h1>
                  <p className="text-slate-600 dark:text-slate-400 max-w-md mx-auto">
                    Siap membantu Anda menganalisis data siswa, jadwal, dan nilai dengan cepat dan akurat.
                  </p>
                </div>
                ...
                <div className="w-full mt-4">
                  <h3 className="text-center text-sm font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-6">Ide Pertanyaan Cepat</h3>
                  <PromptStarters 
